...
public class ExternalChainingHashMap<K, V> {
    ...
    public V put(K key, V value) {
        ...
        if (table[index] == null) {
            ExternalChainingMapEntry<K, V> temp = new ExternalChainingMapEntry<>(key, value);
            table[index] = temp;
        } else {
    ...
    public V remove(K key) {
        ...
        if (table[idx] == null) {
            throw new java.util.NoSuchElementException("Not exist");
        } else {
    ...
    public V get(K key) {
        ...
        ExternalChainingMapEntry<K, V> entry = table[Math.abs(key.hashCode() % table.length)];
